...
<form action="<?= site_url('admin/procces_addNewGallery'); ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <button type="submit" onclick="inikirim()" class="button button-border button-rounded button-fill button-aqua float-right mr-0" id="btn-submit"><span><i class="icon-save"></i> Add gallery</span></button>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea type="text" class="form-control" name="description" id="inputDescription" rows="3" placeholder="Description"></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="inputTags">Tags <small class="text-muted">(optional)</small></label>
                        <input type="text" class="form-control tagsinput" name="tags" id="inputTags" placeholder="Tags">
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    var foto_upload = new Dropzone(".dropzone", {
        ...
        url: "<?= site_url('admin/gallery_uploadPicture/' . $id) ?>",
        maxFilesize: 2,
        parallelUploads: 10,
        method: "post",
        acceptedFiles: "image/*",
        ...
        //     myDropzone.displayExistingFile(mockFile, "https://i.ibb.co/vZF45Zs/default.jpg", callback, crossOrigin, resizeThumbnail);
        ...
        removedfile: function(file) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= site_url('admin/gallery_deletePicture/' . $id) ?>',
                data: {
                    filename: fileName,
                    request: 'delete'
                },
